...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/internal/policy/impl/KeyguardUpdateMonitor$PinPukAttemptsRemaningCallback;,
...
.field private mPinPukAttemptsRemaining:I

.field private mPinPukAttemptsRemainingCallbacks:Ljava/util/ArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/ArrayList",
            "<",
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput v2, p0, Lcom/android/internal/policy/impl/KeyguardUpdateMonitor;->mPinPukAttemptsRemaining:I
    ...
    iput-object v2, p0, Lcom/android/internal/policy/impl/KeyguardUpdateMonitor;->mPinPukAttemptsRemainingCallbacks:Ljava/util/ArrayList;
...
.method private handleSimStateChange(Lcom/android/internal/policy/impl/KeyguardUpdateMonitor$SimArgs;)V
    ...
    iget v0, p1, Lcom/android/internal/policy/impl/KeyguardUpdateMonitor$SimArgs;->pinPukAttemptsRemaining:I
    ...
    .local v2, i:I
    :goto_0
    iget-object v5, p0, Lcom/android/internal/policy/impl/KeyguardUpdateMonitor;->mSimStateCallbacks:Ljava/util/ArrayList;
    ...
    check-cast v5, Lcom/android/internal/policy/impl/KeyguardUpdateMonitor$SimStateCallback;

    invoke-interface {v5, v4}, Lcom/android/internal/policy/impl/KeyguardUpdateMonitor$SimStateCallback;->onSimStateChanged(Lcom/android/internal/telephony/IccCard$State;)V
    ...
    .end local v2           #i:I
    :cond_0
    iget v5, p0, Lcom/android/internal/policy/impl/KeyguardUpdateMonitor;->mPinPukAttemptsRemaining:I

    if-eq v0, v5, :cond_1

    .line 405
    iput v0, p0, Lcom/android/internal/policy/impl/KeyguardUpdateMonitor;->mPinPukAttemptsRemaining:I

    .line 406
    iget-object v5, p0, Lcom/android/internal/policy/impl/KeyguardUpdateMonitor;->mPinPukAttemptsRemainingCallbacks:Ljava/util/ArrayList;
    ...
    check-cast v1, Lcom/android/internal/policy/impl/KeyguardUpdateMonitor$PinPukAttemptsRemaningCallback;

    .line 407
    .local v1, c:Lcom/android/internal/policy/impl/KeyguardUpdateMonitor$PinPukAttemptsRemaningCallback;
    invoke-interface {v1, v0}, Lcom/android/internal/policy/impl/KeyguardUpdateMonitor$PinPukAttemptsRemaningCallback;->onPinPukAttemptsRemainingChanged(I)V

    goto :goto_1

    .line 410
    .end local v1           #c:Lcom/android/internal/policy/impl/KeyguardUpdateMonitor$PinPukAttemptsRemaningCallback;
...
.method public registerPinPukAttemptsRemainingCallback(Lcom/android/internal/policy/impl/KeyguardUpdateMonitor$PinPukAttemptsRemaningCallback;)V
    .locals 1
    .parameter "callback"

    .prologue
    .line 603
    iget-object v0, p0, Lcom/android/internal/policy/impl/KeyguardUpdateMonitor;->mPinPukAttemptsRemainingCallbacks:Ljava/util/ArrayList;
    ...
    .line 606
    iget v0, p0, Lcom/android/internal/policy/impl/KeyguardUpdateMonitor;->mPinPukAttemptsRemaining:I

    invoke-interface {p1, v0}, Lcom/android/internal/policy/impl/KeyguardUpdateMonitor$PinPukAttemptsRemaningCallback;->onPinPukAttemptsRemainingChanged(I)V
