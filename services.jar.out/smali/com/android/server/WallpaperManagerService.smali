...
.field static final WALLPAPER_TMP_DIR:Ljava/io/File;
...
.field private final mTmpWallpaperObserver:Landroid/os/FileObserver;
...
.method static constructor <clinit>()V
    ...
    const-string v1, "/data/data/com.android.settings/files/tmp_wallpaper"

    invoke-direct {v0, v1}, Ljava/io/File;-><init>(Ljava/lang/String;)V

    sput-object v0, Lcom/android/server/WallpaperManagerService;->WALLPAPER_TMP_DIR:Ljava/io/File;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v4, p0, Lcom/android/server/WallpaperManagerService;->mLock:Ljava/lang/Object;
    ...
    iput-object v4, p0, Lcom/android/server/WallpaperManagerService;->mCallbacks:Landroid/os/RemoteCallbackList;
    ...
    invoke-direct {v4, p0, v5, v6}, Lcom/android/server/WallpaperManagerService$1;-><init>(Lcom/android/server/WallpaperManagerService;Ljava/lang/String;I)V

    iput-object v4, p0, Lcom/android/server/WallpaperManagerService;->mWallpaperObserver:Landroid/os/FileObserver;
    ...
    invoke-direct {v4, p0, v5, v6}, Lcom/android/server/WallpaperManagerService$2;-><init>(Lcom/android/server/WallpaperManagerService;Ljava/lang/String;I)V

    iput-object v4, p0, Lcom/android/server/WallpaperManagerService;->mTmpWallpaperObserver:Landroid/os/FileObserver;

    .line 170
    iput v7, p0, Lcom/android/server/WallpaperManagerService;->mWidth:I

    .line 171
    iput v7, p0, Lcom/android/server/WallpaperManagerService;->mHeight:I

    .line 176
    const-string v4, ""

    iput-object v4, p0, Lcom/android/server/WallpaperManagerService;->mName:Ljava/lang/String;
    ...
    const-class v6, Lcom/android/internal/service/wallpaper/ImageWallpaper;
    ...
    iput-object v4, p0, Lcom/android/server/WallpaperManagerService;->mImageWallpaperComponent:Landroid/content/ComponentName;

    .line 345
    iput-object p1, p0, Lcom/android/server/WallpaperManagerService;->mContext:Landroid/content/Context;

    .line 346
    sget-object v4, Lcom/android/server/WallpaperManagerService;->WALLPAPER_TMP_DIR:Ljava/io/File;
    ...
    iput-object v4, p0, Lcom/android/server/WallpaperManagerService;->mIWindowManager:Landroid/view/IWindowManager;

    .line 352
    new-instance v4, Lcom/android/server/WallpaperManagerService$MyPackageMonitor;

    invoke-direct {v4, p0}, Lcom/android/server/WallpaperManagerService$MyPackageMonitor;-><init>(Lcom/android/server/WallpaperManagerService;)V

    iput-object v4, p0, Lcom/android/server/WallpaperManagerService;->mMonitor:Lcom/android/server/WallpaperManagerService$MyPackageMonitor;

    .line 353
    iget-object v4, p0, Lcom/android/server/WallpaperManagerService;->mMonitor:Lcom/android/server/WallpaperManagerService$MyPackageMonitor;

    const/4 v5, 0x1

    invoke-virtual {v4, p1, v5}, Lcom/android/server/WallpaperManagerService$MyPackageMonitor;->register(Landroid/content/Context;Z)V
    ...
    .line 356
    iget-object v4, p0, Lcom/android/server/WallpaperManagerService;->mWallpaperObserver:Landroid/os/FileObserver;

    invoke-virtual {v4}, Landroid/os/FileObserver;->startWatching()V

    .line 357
    iget-object v4, p0, Lcom/android/server/WallpaperManagerService;->mTmpWallpaperObserver:Landroid/os/FileObserver;
...
.method protected finalize()V
    ...
    .line 364
    iget-object v0, p0, Lcom/android/server/WallpaperManagerService;->mTmpWallpaperObserver:Landroid/os/FileObserver;
