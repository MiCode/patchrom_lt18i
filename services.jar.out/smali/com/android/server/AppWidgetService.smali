...
.method static synthetic access$000(Lcom/android/server/AppWidgetService;)Z
    .locals 1
    .parameter "x0"

    .prologue
    .line 86
    invoke-direct {p0}, Lcom/android/server/AppWidgetService;->ensureStateLoadedLocked()Z
...
.method private ensureStateLoadedLocked()Z
    ...
    .line 230
    .local v0, update:Z
    iget-boolean v1, p0, Lcom/android/server/AppWidgetService;->mStateLoaded:Z
    ...
    .line 232
    invoke-virtual {p0}, Lcom/android/server/AppWidgetService;->loadStateLocked()Z
    ...
    iput-boolean v1, p0, Lcom/android/server/AppWidgetService;->mStateLoaded:Z
...
.method private getHostWithTag(Ljava/util/List;I)Lcom/android/server/AppWidgetService$Host;
    .locals 3
    .parameter
    .parameter "tag"
    .annotation system Ldalvik/annotation/Signature;
    ...
    .prologue
    .line 1452
    .local p1, list:Ljava/util/List;,"Ljava/util/List<Lcom/android/server/AppWidgetService$Host;>;"
    ...
    check-cast v0, Lcom/android/server/AppWidgetService$Host;

    .line 1453
    .local v0, host:Lcom/android/server/AppWidgetService$Host;
    iget v2, v0, Lcom/android/server/AppWidgetService$Host;->tag:I
...
.method loadStateLocked()Z
    ...
    invoke-virtual {p0, v2}, Lcom/android/server/AppWidgetService;->readStateFromFileLocked(Ljava/io/FileInputStream;)Z
    :try_end_0
...
.method readStateFromFileLocked(Ljava/io/FileInputStream;)Z
    .locals 28
    .parameter "stream"
    ...
    .line 1317
    .local v20, providerIndex:I
    new-instance v13, Ljava/util/HashMap;

    invoke-direct {v13}, Ljava/util/HashMap;-><init>()V

    .line 1318
    .local v13, loadedProviders:Ljava/util/HashMap;,"Ljava/util/HashMap<Ljava/lang/Integer;Lcom/android/server/AppWidgetService$Provider;>;"
    const/4 v10, 0x0
    ...
    .line 1341
    new-instance v14, Lcom/android/server/AppWidgetService$Provider;

    .end local v14           #p:Lcom/android/server/AppWidgetService$Provider;
    invoke-direct {v14}, Lcom/android/server/AppWidgetService$Provider;-><init>()V
    ...
    iput-boolean v0, v14, Lcom/android/server/AppWidgetService$Provider;->zombie:Z
    ...
    .end local v13           #loadedProviders:Ljava/util/HashMap;,"Ljava/util/HashMap<Ljava/lang/Integer;Lcom/android/server/AppWidgetService$Provider;>;"
    .end local v17           #parser:Lorg/xmlpull/v1/XmlPullParser;
    .end local v20           #providerIndex:I
    ...
    .restart local v13       #loadedProviders:Ljava/util/HashMap;,"Ljava/util/HashMap<Ljava/lang/Integer;Lcom/android/server/AppWidgetService$Provider;>;"
    ...
    .restart local v20       #providerIndex:I
    ...
    .line 1354
    new-instance v9, Lcom/android/server/AppWidgetService$Host;

    invoke-direct {v9}, Lcom/android/server/AppWidgetService$Host;-><init>()V

    .line 1358
    .local v9, host:Lcom/android/server/AppWidgetService$Host;
    const/16 v25, 0x0
    ...
    iput-object v0, v9, Lcom/android/server/AppWidgetService$Host;->packageName:Ljava/lang/String;
    :try_end_3
    ...
    .line 1360
    :try_start_4
    iget-object v0, v9, Lcom/android/server/AppWidgetService$Host;->packageName:Ljava/lang/String;
    ...
    iput v0, v9, Lcom/android/server/AppWidgetService$Host;->uid:I
    :try_end_4
    ...
    :goto_5
    :try_start_5
    iget-boolean v0, v9, Lcom/android/server/AppWidgetService$Host;->zombie:Z
    ...
    iput v0, v9, Lcom/android/server/AppWidgetService$Host;->hostId:I

    .line 1369
    iput v10, v9, Lcom/android/server/AppWidgetService$Host;->tag:I
    ...
    iput-boolean v0, v9, Lcom/android/server/AppWidgetService$Host;->zombie:Z
    :try_end_5
    ...
    .end local v9           #host:Lcom/android/server/AppWidgetService$Host;
    .end local v10           #hostIndex:I
    .end local v13           #loadedProviders:Ljava/util/HashMap;,"Ljava/util/HashMap<Ljava/lang/Integer;Lcom/android/server/AppWidgetService$Provider;>;"
    .end local v17           #parser:Lorg/xmlpull/v1/XmlPullParser;
    .end local v20           #providerIndex:I
    ...
    .line 1376
    new-instance v12, Lcom/android/server/AppWidgetService$AppWidgetId;

    invoke-direct {v12}, Lcom/android/server/AppWidgetService$AppWidgetId;-><init>()V

    .line 1377
    .local v12, id:Lcom/android/server/AppWidgetService$AppWidgetId;
    const/16 v25, 0x0
    ...
    iput v0, v12, Lcom/android/server/AppWidgetService$AppWidgetId;->appWidgetId:I
    ...
    iput-object v0, v12, Lcom/android/server/AppWidgetService$AppWidgetId;->provider:Lcom/android/server/AppWidgetService$Provider;

    .line 1393
    iget-object v0, v12, Lcom/android/server/AppWidgetService$AppWidgetId;->provider:Lcom/android/server/AppWidgetService$Provider;
    ...
    invoke-direct {v0, v1, v8}, Lcom/android/server/AppWidgetService;->getHostWithTag(Ljava/util/List;I)Lcom/android/server/AppWidgetService$Host;

    move-result-object v25

    move-object/from16 v0, v25

    iput-object v0, v12, Lcom/android/server/AppWidgetService$AppWidgetId;->host:Lcom/android/server/AppWidgetService$Host;

    .line 1402
    iget-object v0, v12, Lcom/android/server/AppWidgetService$AppWidgetId;->host:Lcom/android/server/AppWidgetService$Host;
    ...
    .line 1420
    .end local v8           #hIndex:I
    .end local v10           #hostIndex:I
    .end local v12           #id:Lcom/android/server/AppWidgetService$AppWidgetId;
    .end local v13           #loadedProviders:Ljava/util/HashMap;,"Ljava/util/HashMap<Ljava/lang/Integer;Lcom/android/server/AppWidgetService$Provider;>;"
    .end local v17           #parser:Lorg/xmlpull/v1/XmlPullParser;
    .end local v20           #providerIndex:I
