...
.field final synthetic val$usbOtgF:Lcom/android/server/UsbOtgObserver;
...
.method constructor <init>(Lcom/android/server/ServerThread;Lcom/android/server/StatusBarManagerService;Lcom/android/server/BatteryService;Lcom/android/server/ConnectivityService;Lcom/android/server/DockObserver;Lcom/android/server/usb/UsbService;Lcom/android/server/UsbOtgObserver;Lcom/android/server/UiModeManagerService;Lcom/android/server/RecognitionManagerService;Lcom/android/server/AppWidgetService;ZLcom/android/server/WallpaperManagerService;Lcom/android/server/InputMethodManagerService;Lcom/android/server/LocationManagerService;Lcom/android/server/ThrottleService;)V
    ...
    iput-object p7, p0, Lcom/android/server/ServerThread$1;->val$usbOtgF:Lcom/android/server/UsbOtgObserver;
    ...
    iput-object p14, p0, Lcom/android/server/ServerThread$1;->val$locationF:Lcom/android/server/LocationManagerService;

    iput-object p15, p0, Lcom/android/server/ServerThread$1;->val$throttleF:Lcom/android/server/ThrottleService;
...
.method public run()V
    ...
    .line 541
    :cond_4
    iget-object v0, p0, Lcom/android/server/ServerThread$1;->val$usbOtgF:Lcom/android/server/UsbOtgObserver;

    if-eqz v0, :cond_5

    iget-object v0, p0, Lcom/android/server/ServerThread$1;->val$usbOtgF:Lcom/android/server/UsbOtgObserver;

    invoke-virtual {v0}, Lcom/android/server/UsbOtgObserver;->systemReady()V
