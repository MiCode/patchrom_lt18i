...
.method private initDrawables()V
    ...
    invoke-static {v0}, Landroid/widget/TextView;->access$7200(Landroid/widget/TextView;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {v1}, Landroid/widget/TextView;->access$7400(Landroid/widget/TextView;)Landroid/content/Context;
    ...
    invoke-static {v2}, Landroid/widget/TextView;->access$7300(Landroid/widget/TextView;)I
    ...
    invoke-static {v0, v1}, Landroid/widget/TextView;->access$7202(Landroid/widget/TextView;Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {v2}, Landroid/widget/TextView;->access$7600(Landroid/widget/TextView;)I
...
.method private initHandles()V
    ...
    #getter for: Landroid/widget/TextView;->mSelectHandleLeft:Landroid/graphics/drawable/Drawable;
    invoke-static {v2}, Landroid/widget/TextView;->access$7200(Landroid/widget/TextView;)Landroid/graphics/drawable/Drawable;
    ...
    #getter for: Landroid/widget/TextView;->mSelectHandleRight:Landroid/graphics/drawable/Drawable;
    invoke-static {v3}, Landroid/widget/TextView;->access$7500(Landroid/widget/TextView;)Landroid/graphics/drawable/Drawable;
    ...
    #getter for: Landroid/widget/TextView;->mSelectHandleLeft:Landroid/graphics/drawable/Drawable;
    invoke-static {v3}, Landroid/widget/TextView;->access$7200(Landroid/widget/TextView;)Landroid/graphics/drawable/Drawable;
...
.method public onTouchEvent(Landroid/view/MotionEvent;)V
    ...
    invoke-static {v7, v5, v6}, Landroid/widget/TextView;->access$7800(Landroid/widget/TextView;FF)Z
    ...
    invoke-static {v7}, Landroid/widget/TextView;->access$6800(Landroid/widget/TextView;)I
    ...
    invoke-static {v7}, Landroid/widget/TextView;->access$7900(Landroid/widget/TextView;)Z
    ...
    invoke-static {v7, v8}, Landroid/widget/TextView;->access$8002(Landroid/widget/TextView;Z)Z
    ...
    #getter for: Landroid/view/View;->mContext:Landroid/content/Context;
    invoke-static {v7}, Landroid/widget/TextView;->access$8100(Landroid/widget/TextView;)Landroid/content/Context;
