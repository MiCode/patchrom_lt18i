...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    invoke-virtual {p0, p1, v0}, Landroid/graphics/drawable/ClipDrawable;->draw(Landroid/graphics/Canvas;Z)V
...
.method public draw(Landroid/graphics/Canvas;Z)V
    ...
    .line 201
    iget-object v8, p0, Landroid/graphics/drawable/ClipDrawable;->mClipState:Landroid/graphics/drawable/ClipDrawable$ClipState;

    iget-object v8, v8, Landroid/graphics/drawable/ClipDrawable$ClipState;->mDrawable:Landroid/graphics/drawable/Drawable;
    ...
    iget v8, v8, Landroid/graphics/drawable/ClipDrawable$ClipState;->mOrientation:I
    ...
    iget v1, v8, Landroid/graphics/drawable/ClipDrawable$ClipState;->mGravity:I
    ...
    :cond_4
    :goto_1
    invoke-static {v1, v7, v2, v0, v6}, Landroid/view/Gravity;->apply(IIILandroid/graphics/Rect;Landroid/graphics/Rect;)V
    ...
    invoke-virtual {v8, p1, p2}, Landroid/graphics/drawable/Drawable;->draw(Landroid/graphics/Canvas;Z)V
