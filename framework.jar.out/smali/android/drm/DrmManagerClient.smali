...
.method private native _releaseResources(I)V
.end method
...
.method private createListeners()V
    ...
    iget-object v2, p0, Landroid/drm/DrmManagerClient;->mInfoHandler:Landroid/drm/DrmManagerClient$InfoHandler;
    ...
    invoke-direct {p0, v2, v3}, Landroid/drm/DrmManagerClient;->_setListeners(ILjava/lang/Object;)V

    .line 293
    .end local v0           #eventThread:Landroid/os/HandlerThread;
    .end local v1           #infoThread:Landroid/os/HandlerThread;
    :cond_0
    return-void
.end method
...
.method public releaseResources()V
    ...
    invoke-direct {p0, v0}, Landroid/drm/DrmManagerClient;->_releaseResources(I)V
...
.method public removeAllRights()I
    ...
    .end local v0           #msg:Landroid/os/Message;
    :cond_0
    iget-object v2, p0, Landroid/drm/DrmManagerClient;->mOnEventListener:Landroid/drm/DrmManagerClient$OnEventListener;

    if-nez v2, :cond_1

    iget-object v2, p0, Landroid/drm/DrmManagerClient;->mOnInfoListener:Landroid/drm/DrmManagerClient$OnInfoListener;

    if-nez v2, :cond_1

    iget-object v2, p0, Landroid/drm/DrmManagerClient;->mOnErrorListener:Landroid/drm/DrmManagerClient$OnErrorListener;

    if-nez v2, :cond_1

    .line 755
    invoke-virtual {p0}, Landroid/drm/DrmManagerClient;->releaseResources()V
