...
.method private cleanUpConnection(ZLcom/android/internal/telephony/ApnContext;)V
    ...
    const-string v4, "clean up connection already in progress. Ignoring "
...
.method protected onDataSetupComplete(Landroid/os/AsyncResult;)V
    ...
    const-string/jumbo v15, "onDataSetupCompete: No dcac"
    ...
    .end local v6           #cid:I
    :cond_8
    const-string v14, "enable-default-preferred-apn"

    const/4 v15, 0x0

    invoke-static {v14, v15}, Landroid/customization/CustomizedValues;->getBoolean(Ljava/lang/String;Z)Z
    ...
    .line 1965
    .local v10, enableDefaultPreferredApn:Ljava/lang/Boolean;
    ...
    invoke-virtual {v0, v14}, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->isApnTypeActive(Ljava/lang/String;)Z
    ...
    iget-object v14, v0, Lcom/android/internal/telephony/DataConnectionTracker;->mActiveApn:Lcom/android/internal/telephony/ApnSetting;

    if-eqz v14, :cond_9

    .line 1967
    const-string/jumbo v14, "set first preferred APN is null"
    ...
    const-string/jumbo v15, "onDataSetupComplete: permanent error apn=%s"
    ...
    .end local v10           #enableDefaultPreferredApn:Ljava/lang/Boolean;
    :catch_1
    move-exception v9
    ...
    .restart local v10       #enableDefaultPreferredApn:Ljava/lang/Boolean;
    :cond_b
