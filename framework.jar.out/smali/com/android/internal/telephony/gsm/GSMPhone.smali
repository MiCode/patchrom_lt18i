...
.field private mCFOnBootDone:Z

.field private mCFOnBootSim:Z
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/internal/telephony/CommandsInterface;Lcom/android/internal/telephony/PhoneNotifier;Z)V
    ...
    .line 129
    iput-boolean v1, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->mCFOnBootDone:Z

    .line 130
    iput-boolean v1, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->mCFOnBootSim:Z
    ...
    invoke-interface {v0, p0, v1, v5}, Lcom/android/internal/telephony/CommandsInterface;->registerForSIMReady(Landroid/os/Handler;ILjava/lang/Object;)V
...
.method private handleCfuQueryResult([Lcom/android/internal/telephony/CallForwardInfo;)V
    ...
    .line 1622
    :cond_0
    invoke-virtual {p0, v4}, Lcom/android/internal/telephony/gsm/GSMPhone;->storeCFPref(Z)V
    ...
    :goto_2
    invoke-virtual {p0, v2}, Lcom/android/internal/telephony/gsm/GSMPhone;->storeCFPref(Z)V
...
.method private processIccEonsRecordsUpdated(I)V
    ...
    invoke-virtual {v0}, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->updateEons()Z
...
.method private retrieveCFPref()Z
    .locals 4
...
.method public getCallForwardingIndicator()Z
    ...
    .line 302
    invoke-direct {p0}, Lcom/android/internal/telephony/gsm/GSMPhone;->retrieveCFPref()Z
...
.method public final goDataDormant()V
    ...
    invoke-virtual {v0}, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->goDataDormant()V
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-virtual {v0, v14}, Lcom/android/internal/telephony/gsm/GSMPhone;->onBootCallForwardStatus(I)V
    ...
    invoke-virtual {v0, v14}, Lcom/android/internal/telephony/gsm/GSMPhone;->storeCFPref(Z)V

    .line 1400
    move-object/from16 v0, p0

    iget-object v15, v0, Lcom/android/internal/telephony/PhoneBase;->mIccRecords:Lcom/android/internal/telephony/IccRecords;
    ...
    invoke-virtual {v15, v0, v14}, Lcom/android/internal/telephony/IccRecords;->setVoiceCallForwardingFlag(IZ)V
    ...
    iput-boolean v14, v0, Lcom/android/internal/telephony/gsm/GSMPhone;->mCFOnBootDone:Z
    ...
    .end local v10           #onComplete:Landroid/os/Message;
    :pswitch_10
    invoke-direct/range {p0 .. p0}, Lcom/android/internal/telephony/gsm/GSMPhone;->retrieveCFPref()Z
    ...
    invoke-interface {v14, v15}, Lcom/android/internal/telephony/CommandsInterface;->getIMSI(Landroid/os/Message;)V
    ...
    .line 1472
    .local v8, imsiNbr:Ljava/lang/String;
    ...
    .line 1481
    .end local v1           #ar:Landroid/os/AsyncResult;
    .end local v8           #imsiNbr:Ljava/lang/String;
    ...
    invoke-virtual {v15, v14}, Lcom/android/internal/telephony/IccRecords;->getEonsForAvailableNetworks(Ljava/util/ArrayList;)Ljava/util/ArrayList;
...
.method onBootCallForwardStatus(I)V
    .locals 4
    .parameter "caller"
    ...
    .line 1545
    iget-boolean v1, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->mCFOnBootDone:Z
    ...
    const-string/jumbo v2, "onBootCallForwardStatus got sim records"
    ...
    const-string v2, "info is present on sim"

    invoke-static {v1, v2}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 1555
    iput-boolean v3, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->mCFOnBootDone:Z

    .line 1557
    :cond_0
    iput-boolean v3, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->mCFOnBootSim:Z
    ...
    iget-boolean v1, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->mCFOnBootSim:Z
...
.method public setNetworkSelection(Lcom/android/internal/telephony/OperatorInfo$SelectionMode;Lcom/android/internal/telephony/OperatorInfo;Landroid/os/Message;)V
    ...
    const-string/jumbo v3, "setNetworkSelection2: wrapping and sending message to connect automatically"
    ...
    const-string/jumbo v3, "setNetworkSelection2: wrapping and sending message to connect manually"
...
.method public setNetworkSelection(Ljava/lang/String;Lcom/android/internal/telephony/OperatorInfo$SelectionMode;Lcom/android/internal/telephony/OperatorInfo$RAT;Landroid/os/Message;)V
    ...
    const-string/jumbo v3, "setNetworkSelection1: wrapping and sending message to connect automatically"
    ...
    const-string/jumbo v3, "setNetworkSelection1: wrapping and sending message to connect manually"
