...
.field protected static final TETHER_APN_TYPE_IS_ALL_PROPERTY:Ljava/lang/String; = "tether_apn_type_is_all"
...
.method static constructor <clinit>()V
    ...
    :goto_0
    sput-boolean v0, Lcom/android/internal/telephony/DataConnectionTracker;->DBG:Z
...
.method private setEnabled(IZ)V
    ...
    .prologue
    .line 517
    sget-boolean v1, Lcom/android/internal/telephony/DataConnectionTracker;->DBG:Z
...
.method public declared-synchronized enableApnType(Ljava/lang/String;)I
    ...
    :cond_0
    :try_start_1
    sget-boolean v2, Lcom/android/internal/telephony/DataConnectionTracker;->DBG:Z
    ...
    const-string/jumbo v3, "type not available"
    ...
    .line 466
    :cond_3
    const-string/jumbo v2, "tether_apn_type_is_all"

    const/4 v3, 0x0

    invoke-static {v2, v3}, Landroid/customization/CustomizedValues;->getBoolean(Ljava/lang/String;Z)Z

    move-result v1

    .line 468
    .local v1, isTetherApnTypeAll:Z
    if-eqz v1, :cond_5
    ...
    const-string/jumbo v3, "tether is on and apn type is all"
    ...
    invoke-direct {p0, v0, v2}, Lcom/android/internal/telephony/DataConnectionTracker;->setEnabled(IZ)V
    ...
    .line 449
    .end local v0           #id:I
    .end local v1           #isTetherApnTypeAll:Z
    :catchall_0
    move-exception v2
