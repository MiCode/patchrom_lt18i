...
.method private persistData(Lcom/google/android/mms/pdu/PduPart;Landroid/net/Uri;Ljava/lang/String;)V
    ...
    .line 769
    .local v6, encodedParser:Lcom/google/android/mms/pdu/EncodedStringValue;
    if-eqz v3, :cond_3

    .line 770
    new-instance v6, Lcom/google/android/mms/pdu/EncodedStringValue;

    .end local v6           #encodedParser:Lcom/google/android/mms/pdu/EncodedStringValue;
    invoke-virtual {p1}, Lcom/google/android/mms/pdu/PduPart;->getCharset()I

    move-result v10

    invoke-direct {v6, v10, v3}, Lcom/google/android/mms/pdu/EncodedStringValue;-><init>(I[B)V

    .line 774
    .restart local v6       #encodedParser:Lcom/google/android/mms/pdu/EncodedStringValue;
    :goto_0
    ...
    invoke-virtual {v10, v0, v2, v11, v12}, Landroid/content/ContentResolver;->update(Landroid/net/Uri;Landroid/content/ContentValues;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    invoke-direct {v10, v5}, Lcom/google/android/mms/MmsException;-><init>(Ljava/lang/Throwable;)V
    ...
    invoke-direct {v6, v10}, Lcom/google/android/mms/pdu/EncodedStringValue;-><init>(Ljava/lang/String;)V
    ...
    invoke-virtual {v10, v4}, Landroid/content/ContentResolver;->openInputStream(Landroid/net/Uri;)Ljava/io/InputStream;
...
.method public load(Landroid/net/Uri;)Lcom/google/android/mms/pdu/GenericPdu;
    ...
    .prologue
    .line 529
    sget-object v28, Lcom/google/android/mms/pdu/PduPersister;->PDU_CACHE_INSTANCE:Lcom/google/android/mms/util/PduCache;
    ...
    .end local v15           #headers:Lcom/google/android/mms/pdu/PduHeaders;
    ...
    .restart local v15       #headers:Lcom/google/android/mms/pdu/PduHeaders;
...
.method public persist(Lcom/google/android/mms/pdu/GenericPdu;Landroid/net/Uri;)Landroid/net/Uri;
    ...
    .line 1065
    :cond_1
    sget-object v44, Lcom/google/android/mms/pdu/PduPersister;->PDU_CACHE_INSTANCE:Lcom/google/android/mms/util/PduCache;
    ...
    .end local v39           #set:Ljava/util/Set;,"Ljava/util/Set<Ljava/util/Map$Entry<Ljava/lang/Integer;Ljava/lang/String;>;>;"
    .end local p1
    :catchall_0
    move-exception v4
    ...
    .restart local v39       #set:Ljava/util/Set;,"Ljava/util/Set<Ljava/util/Map$Entry<Ljava/lang/Integer;Ljava/lang/String;>;>;"
    .restart local p1
    :cond_3
    :try_start_1
    ...
    invoke-virtual/range {v35 .. v35}, Lcom/google/android/mms/pdu/PduPart;->getContentType()[B
    ...
    .line 1172
    invoke-virtual/range {v35 .. v35}, Lcom/google/android/mms/pdu/PduPart;->getCharset()I
    ...
    .line 1187
    .end local v16           #charset:I
    .end local v18           #charsetPreValue:I
    .end local v19           #contentType:Ljava/lang/String;
    .end local v26           #i:I
